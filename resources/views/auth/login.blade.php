...
@section('content')
    ...
    <main class="m-0">
        <div class=" login_form col-md-3 justify-content-center position-absolute z-3">
            <div class="">
                <div class="">
                    <a href="" class="logo">
                        <img src="{{asset('/storage/images/Vertical Graphics.png')}}" width="350px" height="auto" class="" alt="">
                    </a>
                    <div class="card-body">
        ...
        <div class="school-images z-1" style="width: 100%">
