...
<nav id="sidebar" class=" sidebar">
    ...
    <ul class="nav mt-5">
        ...
        <li class="{{Request::is('') ? 'active' : ''}} p-3">
            <div class="">
                <a href="{{route('dashboard')}}" class="nav_btns text-white" style="text-decoration: none">Instructors
        ...
        <li class="{{Request::is('') ? 'active' : ''}} p-3">
            <div class="">
                <a href="{{route('dashboard')}}" class="nav_btns text-white" style="text-decoration: none">Reports
